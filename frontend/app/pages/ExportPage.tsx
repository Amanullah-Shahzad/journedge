...
export default function ExportPage() {
  ...
  const exportDatasetQuery = useExportDatasetQuery({
    accountId: activeAccount?.id ?? null,
    startDate: options.dateFrom || undefined,
    endDate: options.dateTo || undefined,
    tickers: options.tickers,
    tags: options.tags,
    statuses: options.status === "all" ? [] : [options.status],
  });

  const filteredTrades = exportDatasetQuery.data?.trades ?? [];
